...
class Juego():
    ...
    def jugar_torneo(self, partidos, *jugadores, modo="ordered", verbose=1,
                        barra=None, **kwargs):
        """
        modo -
...
class TicTacToe(Juego):
    ...
    def __init__(self, h=6, v=6, k=4, *args, **kwargs):
...
#print("Bienvenido a 4 en raya seleccione su adversario:\n")
#tipo_de_juego=int(input("1.- Jugagar con 1 amigo\n2.- jugador Aleatorio\n3.- Jugador Alfa Beta\n4.- Jugador Minimax\n5.- Jugador Poda Alfa Beta\nEligio: "))
...
juego = TicTacToe()
juego.jugar_torneo(1, *jugadores, verbose=3)
